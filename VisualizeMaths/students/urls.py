...
urlpatterns = [
    ...
    path('changePassword/', views.changePassword, name='changePassword') #url pointing to views.changePassword which returns a page allowing users to change their password
]